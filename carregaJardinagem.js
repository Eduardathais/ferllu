const URL1 = "https://q45rmviz.api.sanity.io/v2022-03-07/data/query/production?query=*%5B_type+%3D%3D+%22itensDeJardinagem%22%5D+%7B%0A++nome%2C+%0A++%22imagem%22%3A+imagem.asset-%3Eurl%0A%7D";
...
window.addEventListener("load", async function() {
    ...
    for (let i = 0; i < json.result.length; i++) {
        ...
        descricao.innerText = json.result[i].descricao || "Descrição do item";
